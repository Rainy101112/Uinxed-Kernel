...
{
    __asm__ volatile(LOCK_PREFIX "addl %1,%0" : "+m"(v->counter) : "ir"(i));
}

static inline void atomic_sub(atomic_t *v, int32_t i)
{
    __asm__ volatile(LOCK_PREFIX "subl %1,%0" : "+m"(v->counter) : "ir"(i));
}
...
static inline int32_t atomic_sub_and_test(atomic_t *v, int32_t i)
{
    ...
    __asm__ volatile(LOCK_PREFIX "subl %2,%0; sete %1" : "+m"(v->counter), "=qm"(c) : "ir"(i) : "memory");
    return c;
}

static inline void atomic_inc(atomic_t *v)
{
    __asm__ volatile(LOCK_PREFIX "incl %0" : "+m"(v->counter));
}
...
static inline int32_t atomic_inc_and_test(atomic_t *v)
{
    ...
    __asm__ volatile(LOCK_PREFIX "incl %0; sete %1" : "+m"(v->counter), "=qm"(c) : : "memory");
    return (c != 0);
}

static inline void atomic_dec(atomic_t *v)
{
    __asm__ volatile(LOCK_PREFIX "decl %0" : "+m"(v->counter));
}
...
static inline int32_t atomic_dec_and_test(atomic_t *v)
{
    ...
    __asm__ volatile(LOCK_PREFIX "decl %0; sete %1" : "+m"(v->counter), "=qm"(c) : : "memory");
    return (c != 0);
}
